...
export const RegistrationPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-6xl bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[680px]">
        
        {/* Left Hero Section (5/12 = 42% on desktop, hidden on mobile) */}
        <div className="hidden lg:flex lg:col-span-5 h-full">
          <FootballPitchSideHero 
            title="Enter The Roster Pool"
            subtitle="Submit your profile, jersey details, and position tier to get drafted by franchise managers."
          />
        </div>

        {/* Right Form Section (7/12 = 58% on desktop, 100% on mobile) */}
        <div className="lg:col-span-7 p-6 md:p-10 flex flex-col justify-between bg-slate-900/60 backdrop-blur-xl">
          
          <div>
            {/* Top Switcher Navigation */}
            <div className="flex bg-slate-950 p-1 rounded-2xl border border-slate-800 mb-6 max-w-xs">
              <Link 
                to="/login"
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-400 mt-1">
                Fill in your details below to enter the upcoming franchise auction.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      className="pl-10 h-11 bg-slate-950/70 border-slate-800 text-white placeholder:text-slate-500 focus:border-emerald-500 focus:ring-emerald-500/20 rounded-xl text-sm"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <select 
                      ...
                      onChange={handleInputChange} 
                      className="pl-10 pr-4 h-11 w-full rounded-xl border border-slate-800 bg-slate-950/70 text-white text-sm focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                    >
              ...
              <Button 
                ...
                className="w-full h-12 mt-4 bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white font-bold rounded-xl shadow-lg shadow-emerald-950/50 transition-all duration-200 flex items-center justify-center space-x-2"
              >
